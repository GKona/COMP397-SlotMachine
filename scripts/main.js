...
// Image sources
var sources = {
    sevens: 'assets/img/7s.jpg',
    bananas: 'assets/img/bananas.png',
    bars: 'assets/img/bars.jpg',
    bells: 'assets/img/bells.jpg',
    cherries: 'assets/img/cherries.jpg',
    grapes: 'assets/img/grapes.jpg',
    oranges: 'assets/img/oranges.jpg',
    blank: 'assets/img/blank.jpg',
    qReel: 'assets/img/Q.png',
    timer1: 'assets/img/timer1.png',
    timer2: 'assets/img/timer2.png'
};
...
window.onload = function () {
    ...
    sPannel.src = "assets/img/sPannel.png";
    ...
    var spinSnd = new Audio("assets/snd/spin.wav");
    var winSnd = new Audio("assets/snd/win.wav");
    var loseSnd = new Audio("assets/snd/lose.wav");
    var coinSnd = new Audio("assets/snd/coin.wav");
    var jackpotSnd = new Audio("assets/snd/jackpot.wav");
    var quitSnd = new Audio("assets/snd/quit.wav");
    var startSnd = new Audio("assets/snd/start.wav");
    var resetSnd = new Audio("assets/snd/reset.wav");
    var tickSnd = new Audio("assets/snd/tick.wav");
